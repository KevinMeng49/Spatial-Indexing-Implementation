...
public:
	...
	Envelope intersection(const Envelope& envelope)const;
};
...
public:
	...
	bool bInPolygon(const Polygon* polygon)const;
};
...
public:
	...
	//intersection test with another LineString
	virtual bool intersection(const LineString* line) const;
